...
public class Client extends Thread {
    ...
    public Client() {
        ...
        final JFrame jfr = new JFrame("Golpo");
        ...
        final JTextField jtfPass = new JTextField("PORT");
        ...
        jcbtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    if (pass.equals("")) {
                        JOptionPane.showMessageDialog(jfr, "Please enter PORT.");
                        return;
                    }
